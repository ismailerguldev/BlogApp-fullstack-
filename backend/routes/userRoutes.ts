...
import { autoLogin, changePassword, changeUsername, follow, getUser, login, logout, register, verify } from "../controllers/userControllers.ts"
...
router.route("/get/:user_id").get(tokenVerify, getUser)
